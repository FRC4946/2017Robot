...
public class RobotMap {
	...
	public static final int CAN_TALON_SHOOTER_A = 4;
	public static final int CAN_TALON_SHOOTER_B = 5;
	...
	public static final int DIO_BALL_SENSOR = 8;
	public static final int DIO_SHOOTER_SENSOR = 9;

	public static final int DIO_LIMIT_SWITCH_WINCH = 6; // Not Needed

	public static final int PCM_SHOOTER_HOOD = 0;
	public static final int PCM_GEAR_PUSHER = 1;
	public static final int PCM_LEFT_FLIPPER = 2;
	public static final int PCM_RIGHT_FLIPPER = 3;
	public static final int PCM_PAD_PUSHER = 4;
	// public static final int PCM_DOOR_OPENER_1 = 7; // Not Needed
	// public static final int PCM_DOOR_OPENER_2 = 8; // Not Needed
